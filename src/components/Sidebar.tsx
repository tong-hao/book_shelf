    ...
    return (
      <Tooltip content="展开侧栏">
        <button
          ...
          className="fixed left-2 top-20 z-10 p-2 rounded-lg bg-bookshelf-card border border-bookshelf-border hover:bg-gray-100 transition-colors shadow-sm"
      >
